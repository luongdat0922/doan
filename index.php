...
<body>
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    <p>Success isn't always about greatness. It's about
                        consistency. Consistent<br />hard work gians success. Greatness
                        will come.</p>
    ...
    <div class="offer">
        <div class="small-container">
            <div class="row">
                <div class="col-2">
                    <img src="./public/images/exclusive.png" class="offer-image">
                </div>
                <div class="col-2">
                    ...
                    adjustable brightness, so everything is clear as can.</small>
        ...
        <div class="small-container">
            <div class="row">
                <div class="col-3">
                    ...
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi quae provident sint ratione facere suscipit 
                    modi recusandae quas iste inventore.</p>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
